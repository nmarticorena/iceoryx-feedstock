About iceoryx-feedstock
=======================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/iceoryx-feedstock/blob/main/LICENSE.txt)

Home: https://iceoryx.io/

Package license: Apache-2.0 AND MIT AND EPL-2.0

Summary: Eclipse iceoryx - true zero-copy inter-process-communication

Development: https://github.com/eclipse-iceoryx/iceoryx
...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/iceoryx-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/iceoryx-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
      ...
      <details>
        <summary>
          <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=26799&branchName=main">
            <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/iceoryx-feedstock?branchName=main">
          </a>
        </summary>
        <table>
...
| --- | --- | --- | --- |
| [![Conda Recipe](https://img.shields.io/badge/recipe-iceoryx-green.svg)](https://anaconda.org/conda-forge/iceoryx) | [![Conda Downloads](https://img.shields.io/conda/dn/conda-forge/iceoryx.svg)](https://anaconda.org/conda-forge/iceoryx) | [![Conda Version](https://img.shields.io/conda/vn/conda-forge/iceoryx.svg)](https://anaconda.org/conda-forge/iceoryx) | [![Conda Platforms](https://img.shields.io/conda/pn/conda-forge/iceoryx.svg)](https://anaconda.org/conda-forge/iceoryx) |
| [![Conda Recipe](https://img.shields.io/badge/recipe-libiceoryx--binding--c-green.svg)](https://anaconda.org/conda-forge/libiceoryx-binding-c) | [![Conda Downloads](https://img.shields.io/conda/dn/conda-forge/libiceoryx-binding-c.svg)](https://anaconda.org/conda-forge/libiceoryx-binding-c) | [![Conda Version](https://img.shields.io/conda/vn/conda-forge/libiceoryx-binding-c.svg)](https://anaconda.org/conda-forge/libiceoryx-binding-c) | [![Conda Platforms](https://img.shields.io/conda/pn/conda-forge/libiceoryx-binding-c.svg)](https://anaconda.org/conda-forge/libiceoryx-binding-c) |
...
Installing `iceoryx` from the `conda-forge` channel can be achieved by adding `conda-forge` to your channels with:
...
mamba repoquery search iceoryx --channel conda-forge

# List packages depending on `iceoryx`:
mamba repoquery whoneeds iceoryx --channel conda-forge
...
Updating iceoryx-feedstock
==========================

If you would like to improve the iceoryx recipe or build a new
...
Note that all branches in the conda-forge/iceoryx-feedstock are
